...
public class Jdbc3DDL {
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		/*
		 * =======================================================================
		 * ORNEK1:isciler adinda bir tablo olusturunuz id NUMBER(3), birim VARCHAR2(10),
		 * maas NUMBER(5)
		 * ========================================================================
		 */
		String createQuery = "CREATE TABLE isciler" + " (id NUMBER(3)," + " birim VARCHAR2(10)," + " maas NUMBER(5))";
		// 1.YONTEM (excute() metodu ile)
		// boolean s1 = st.execute(creatQuery); // false deger dondurur.
		// System.out.println("isciler tablosu olusturuldu" + s1);

		// st.execute(createQuery); // false deger dondurur.(DDL)
		...
		/*
		 * =======================================================================
		 * ORNEK4:isciler tablosuna soyisim VARCHAR2(20) ve sehir VARCHAR2(10)) adinda 2
		 * yeni sutun ekleyiniz.
		 * ========================================================================
		 */
